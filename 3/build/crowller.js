...
var xiaoxiaoweiiAnalyzer_1 = __importDefault(require("./xiaoxiaoweiiAnalyzer"));
var Crowller = /** @class */ (function () {
    function Crowller(url, anylyzer) {
        this.url = url;
        this.anylyzer = anylyzer;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        html = _a.sent();
                        fileContent = this.anylyzer.anylyze(html, this.filePath);
...
var anylyzer = xiaoxiaoweiiAnalyzer_1.default.getInstance();
